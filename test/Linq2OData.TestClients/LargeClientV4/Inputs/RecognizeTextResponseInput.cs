...
/// <summary>
/// OdataName: RecognizeTextResponse
/// </summary>
public partial class RecognizeTextResponseInput : ODataInputBase
{
	// IsEnumType: False
    public decimal? countOfPages 
	{
		get => GetValue<decimal?>("countOfPages");
		set => SetValue("countOfPages", value);
	}
